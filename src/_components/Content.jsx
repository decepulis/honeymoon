  ...
  return (
    <>
      ...
      <p className="mb-4">
        ...
        layouts for our <Link href="https://www.mux.com/core/stream-video-files">docs</Link>. <i>Next</i> thing I knew,
        I was fetching data directly in my components and streaming them to the client. It was love at first sight.
      </p>
